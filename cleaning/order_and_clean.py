...
image_files = glob.glob(os.path.join(input_dir, "images", "*"))

sorted_json_files = sorted(json_files, key=extract_number)
...
pairs = list(zip(sorted_json_files, sorted_image_files))
