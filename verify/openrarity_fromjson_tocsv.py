...
# Prepare CSV file
with open('token_rarity.csv', 'w', newline='') as file:
    writer = csv.writer(file)
    writer.writerow(["Token", "Rank", "Score", "Unique attributes"]) # Write header
    ...
    for token_rarity in ranked_tokens:
        ...
        # Write to CSV
        writer.writerow([token_id, rank, score, unique_attributes])
